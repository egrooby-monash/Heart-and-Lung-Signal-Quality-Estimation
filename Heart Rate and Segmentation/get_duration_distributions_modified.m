...
function [d_distributions, max_S1, min_S1, max_S2, min_S2, max_systole, min_systole, max_diastole, min_diastole] = get_duration_distributions_modified(heartrate,systolic_time)
...
%std_factor=(185-120)/(115-60);
mean_factor=1;
std_factor=1;
%mean_S1 = round(0.122*springer_options.audio_segmentation_Fs);
%std_S1 = round(0.022*springer_options.audio_segmentation_Fs);
mean_S1 = round(0.122/mean_factor*springer_options.audio_segmentation_Fs);
std_S1 = round(0.022*std_factor*springer_options.audio_segmentation_Fs);
%mean_S2 = round(0.094*springer_options.audio_segmentation_Fs);
%std_S2 = round(0.022*springer_options.audio_segmentation_Fs);
mean_S2 = round(0.094/mean_factor*springer_options.audio_segmentation_Fs);
std_S2 = round(0.022*std_factor*springer_options.audio_segmentation_Fs);
