...
function [peak_pos,assigned_states] = get_schmidt_hmm_peakpos_original(audio, Fs,figures)
...
[heart_rate, systolic_time] = getHeartRateSchmidt_original(audio, Fs);
...
%% Decoding
[~, ~, qt] = viterbiDecodePCG_SQI_original(homomorphic_envelope, pi_vector, b_matrix,heart_rate, systolic_time, springer_options.audio_segmentation_Fs);
