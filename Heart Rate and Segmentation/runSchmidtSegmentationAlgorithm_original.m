...
function assigned_states = runSchmidtSegmentationAlgorithm_original(audio_data, Fs, figures)
...
[~, ~, qt] = viterbiDecodePCG_Schmidt_original(PCG_Features, pi_vector, B_matrix,heartRate, systolicTimeInterval, featuresFs);
