...
function assigned_states = runSpringerSegmentationAlgorithm_modified(audio_data, Fs, figures)
...
[~, ~, qt] = viterbiDecodePCG_Springer_modified(PCG_Features, pi_vector, B_matrix, total_observation_distribution, heartRate, systolicTimeInterval, featuresFs);
