...
function assigned_states = runSpringerSegmentationAlgorithm_original(audio_data, Fs, figures)
...
load('hmm.mat', 'total_obs_distribution')
...
B_matrix=b_matrix; 
total_observation_distribution=total_obs_distribution;
%}
...
total_observation_distribution=Springer_total_obs_distribution;
...
[heartRate, systolicTimeInterval] = getHeartRateSchmidt_original(audio_data, Fs);

[~, ~, qt] = viterbiDecodePCG_Springer_original(PCG_Features, pi_vector, B_matrix, total_observation_distribution, heartRate, systolicTimeInterval, featuresFs);
