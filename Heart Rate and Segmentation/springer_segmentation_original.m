function assigned_states= springer_segmentation_original(audio_data,Fs, heartRate, systolicTimeInterval)
%% Paper Information
...
[~, ~, qt] = viterbiDecodePCG_Springer_original(PCG_Features, Springer_pi_vector, Springer_B_matrix, Springer_total_obs_distribution, heartRate, systolicTimeInterval, featuresFs);
