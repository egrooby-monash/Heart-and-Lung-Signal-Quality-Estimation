...
function [PCG_Features, featuresFs] = getSpringerPCGFeatures2(audio_data, Fs, figures)
...
tic
audio_data2 = resample(audio_data, round(Fs/10), Fs);
psd = get_PSD_feature_Springer_HMM(audio_data2, round(Fs/10), 40,60)';
psd = resample(psd, Fs, round(Fs/10));
